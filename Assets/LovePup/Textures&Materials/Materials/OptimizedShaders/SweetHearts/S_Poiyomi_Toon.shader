Shader "Hidden/Locked/.poiyomi/Poiyomi 7.3/• Poiyomi Toon •/bdd0df2fe7cec7b4c8850bf254c92e7b"
{
    Properties
    {
        ...
        _DecalBlendAlpha_SweetHearts("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha1_SweetHearts("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha2_SweetHearts("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha3_SweetHearts("Alpha", Range(0,1)) = 1
