Shader "Hidden/Locked/.poiyomi/Poiyomi 7.3/• Poiyomi Toon •/ff73583d75e40b847bf16daf9ccf1b87"
{
    Properties
    {
        ...
        _DecalBlendAlpha_PupEars26TailBlack("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha1_PupEars26TailBlack("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha2_PupEars26TailBlack("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha3_PupEars26TailBlack("Alpha", Range(0,1)) = 1
        ...
        _EmissionStrength_PupEars26TailBlack ("Emission Strength", Range(0, 20)) = 0
