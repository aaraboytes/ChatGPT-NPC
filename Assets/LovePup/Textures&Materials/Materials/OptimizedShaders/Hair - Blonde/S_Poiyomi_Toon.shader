Shader "Hidden/Locked/.poiyomi/Poiyomi 7.3/• Poiyomi Toon •/24b78a902fc14cf4a82aa34372f9e955"
{
    Properties
    {
        ...
        _DecalBlendAlpha_Hair2DBlonde("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha1_Hair2DBlonde("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha2_Hair2DBlonde("Alpha", Range(0,1)) = 1
        ...
        _DecalBlendAlpha3_Hair2DBlonde("Alpha", Range(0,1)) = 1
